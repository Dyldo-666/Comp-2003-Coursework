...
const Privacy: PageLayoutProps = () => {
  return (
    <>
      ...
      <br />
      Engame built the Tap Master app or web app as a Free app. This SERVICE is
      provided by Engame at no cost and is intended for use as is.
      <br />
      ...
      Terms and Conditions, which is accessible in Tap Master unless otherwise
      ...
      name, operating system version, browser information, and the configuration
      of the app when utilizing our Service, the time and date of your use of
      ...
      13. In the case we discovered a child under 13 has provided us with
      personal information, we immediately delete their information from our
      ...
      <br />
      We may update our Privacy Policy periodically without prior notification.
      Thus, you are advised to review this page periodically for any changes
      periodically. We will notify you of any changes by posting the new Privacy
      ...
      hesitate to contact us at enquiry@engame.tech
      <br />
      <br />
    </>
  );
