    ...
    >
      <Section bgColor={backgroundImage ? "bg-transparent" : "bg-white"}>
        <div className="flex flex-col items-center py-10">
          <p className="text-center uppercase md:text-center font-montserrat font-semibold text-3xl mb-2">
            Pick a plan to boost your sales, brand, and market with now!
          </p>
          <hr className="mb-5 mx-auto w-1/3 md:w-1/3 text-center border-black border-2 "/>
